...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(10, 70);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(120, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Показати текст";
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(201, 219);
			...
			this->ClientSize = System::Drawing::Size(270, 251);
